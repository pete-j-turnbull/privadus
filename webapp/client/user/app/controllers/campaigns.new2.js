...
//                            Need to find some way of deleting the campaign now ...
    ...
    .controller('AdHandlerCtrl', ['$scope', 'CampaignModel',
        function ($scope, CampaignModel) {
            $scope.ads = CampaignModel.ads;
...
//                File validation here
    ...
    .controller('VoucherHandlerCtrl', ['$scope', 'CampaignModel',
        function ($scope, CampaignModel) {
            $scope.vouchers = CampaignModel.vouchers;
            $scope.$on('flow::fileAdded', function (event, $flow, file) {
//                File validation here
            })
            $scope.$on('flow::fileSuccess', function (event, $flow, file, msg) {
    ...
    .factory("CampaignModel",
        function() {
            return {
                init_flow: function ($adflow, $vflow) {
                    this.ads = $adflow.files;
                    this.vouchers = $vflow
                },
                reset: function () {
